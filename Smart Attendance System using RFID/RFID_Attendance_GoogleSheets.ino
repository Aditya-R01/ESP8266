...
const String sheet_url = "https://script.google.com/macros/s/AKfycbx76pj7WRBOM2xxMUn-SMv9eWdzSd2hb909-dj68RUehTC3iGn0oiJNpJxjpDZxkr0j/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "Realme"  //Enter WiFi Name
#define WIFI_PASSWORD "987654321"  //Enter WiFi Password
//-----------------------------------------

//Initialize the LCD display
LiquidCrystal_PCF8574 lcd(0x27);  //Change LCD Address to 0x27 if 0x3F doesnt work
